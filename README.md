...
```
npm create cloudflare@latest -- --template=cloudflare/templates/broad-bar-ec0b
```

A live public deployment of this template is available at [https://broad-bar-ec0b.templates.workers.dev](https://broad-bar-ec0b.templates.workers.dev)
